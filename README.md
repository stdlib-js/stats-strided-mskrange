...
```javascript
mskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskrange@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-mskrange/tags). For example,

```javascript
mskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskrange@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var mskrange = require( 'path/to/vendor/umd/stats-strided-mskrange/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskrange@umd/browser.js"></script>
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-mskrange.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-mskrange/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-mskrange/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-mskrange/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-mskrange/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-mskrange/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-mskrange/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-mskrange/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-mskrange/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-mskrange/main/LICENSE
